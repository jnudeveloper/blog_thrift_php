...
class AdditionServiceClient implements \thriftgen\service\AdditionServiceIf {
  ...
  {
    $args = new \thriftgen\service\AdditionService_add_args();
    $args->n1 = $n1;
    $args->n2 = $n2;
  ...
  public function recv_add()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\thriftgen\service\AdditionService_add_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \thriftgen\service\AdditionService_add_result();
